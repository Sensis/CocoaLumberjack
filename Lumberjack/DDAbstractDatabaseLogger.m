...
- (void)updateAndResumeSaveTimer
{
	if ((saveTimer != NULL) && (saveInterval > 0.0) && (unsavedTime > 0.0))
	{
		...
		dispatch_time_t startTime = dispatch_time(unsavedTime, (long long)interval);
...
- (void)updateDeleteTimer
{
	if ((deleteTimer != NULL) && (deleteInterval > 0.0) && (maxAge > 0.0))
	{
		...
		if (lastDeleteTime > 0)
			startTime = dispatch_time(lastDeleteTime, (long long)interval);
		else
			startTime = dispatch_time(DISPATCH_TIME_NOW, (long long)interval);
